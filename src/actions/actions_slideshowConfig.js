...
export const GET_CONFIG_FROM_DATABASE_REJECTED = 'GET_CONFIG_FROM_DATABASE_REJECTED';
export const UPDATE_CONFIG_IN_DATABASE = 'UPDATE_CONFIG_IN_DATABASE';
export const UPDATE_CONFIG_IN_DATABASE_REJECTED = 'UPDATE_CONFIG_IN_DATABASE_FULFILLED';
