...
export const GET_CONFIG_FROM_DATABASE_FULFILLED =
  'GET_CONFIG_FROM_DATABASE_FULFILLED';
export const GET_CONFIG_FROM_DATABASE_REJECTED =
  'GET_CONFIG_FROM_DATABASE_REJECTED';
export const UPDATE_CONFIG_IN_DATABASE = 'UPDATE_CONFIG_IN_DATABASE';
export const UPDATE_CONFIG_IN_DATABASE_REJECTED =
  'UPDATE_CONFIG_IN_DATABASE_FULFILLED';
...
export const uploadFile = (acceptedFiles, activeFolder) => dispatch => {
  ...
  return new Promise(function(resolve, reject) {
    dispatch(getConfigFromDatabase(activeFolder)).then(data => {
